...
ALARM_PATH := vendor/tenx/prebuilt/common/media/audio/alarms
NOTIFICATION_PATH := vendor/tenx/prebuilt/common/media/audio/notifications
RINGTONE_PATH := vendor/tenx/prebuilt/common/media/audio/ringtones
